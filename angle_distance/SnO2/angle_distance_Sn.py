...
def main():
    file_path = 'angle_distance/SnO2/POSCAR_Sn'
    center_element = 'Sn'  # 假设中心原子是 Sn
    neighbor_element = 'O'  # 假设配位原子是 O
    min_distance = 1.5  # 配位原子选择的最小距离（单位Å）
    max_distance = 2.5  # 配位原子选择的最大距离（单位Å）
    ...
    output_file_path = 'angle_distance/SnO2/geo_txt'  # 输出文件路径
